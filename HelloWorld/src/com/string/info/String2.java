...
public class String2 {
	...
	public static void main(String[] args) {
		...
		//Letra en la posición indicada:
		System.out.println(texto.charAt(0));
		System.out.println(texto.charAt(6));
		System.out.println(texto.charAt(texto.length()-1));
		//para conseguir la última posición del String:
		int longitud=texto.length();
		int ultimaposicion=longitud-1;
		System.out.println(texto.charAt(ultimaposicion)); //Sería igual que la línea 12
		//Nos devuelve en que posición se encuentra la letra o string que deseamos:
		...
		//Empieza a contar a partir del numero que se le asigna, por ende la "o" estará en la posición 15 que se la final
		System.out.println(texto.indexOf('o',6));
		//Al no encontrar la cadena de caracteres a partir de esta posición devuelve: -1:
		...
		la ultima posición si tuviese valor como en el segundo caso [6,10):*/
